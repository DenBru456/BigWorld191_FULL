...
import math
from events import ParticleSubSystemEvent
...
from events import MATRIX_SWARM_PSA
...
#------------------------------------------------------------------------------
class AOEVictimNodeList( ParticleSubSystemEvent ):
	def __init__( self ):
		ParticleSubSystemEvent.__init__( self )
		self.maxRange = 25.0
		self.nodeList = []
