...
class CharacterPage extends AuthenticatedXHTMLMPPage
{
	...
	function renderBody()
	{
		...
		$descriptionHtml = xhtmlMpDiv(
			xhtmlMpSpan("FantasyDemo ". ucfirst( $this->charClass ), 
				'character-title' ).
			xhtmlMpSingleTag( 'br' ).
			"A young ". $this->charClass. ", you hail from the chaotic
			Highlands of FantasyDemo, where great swords are forged from fiery
			craters, and great staves of power, imbued with powerful magics,
			are crafted by village mystics. These tools are yours to wield as
			you patrol the countryside, fighting marauding orcs and hunting
			giant spiders.",
