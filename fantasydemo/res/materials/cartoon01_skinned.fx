		...
		uniform int nDirectionals)
{
	...
	float2x3 difSpec1 = LightArray(nDirectionals, surfPos1, surfNorm1, eyePos, 8);
...
{
	compile vs_2_0 Technique1_Pass1_VS(0),
	compile vs_2_0 Technique1_Pass1_VS(1),
	compile vs_2_0 Technique1_Pass1_VS(2)
};
...
>
{
	pass Pass1
	{
		VertexShader = (vertexShaders[nSpecularDirectionalLights]);
		//VertexShader = compile vs_2_0 Technique1_Pass1_VS(projTM, lightArray, worldTM, worldITTM, eyePos);
